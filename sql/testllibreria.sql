...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-03-2017 a las 17:11:19
...
INSERT INTO `booked` (`idBook`, `idUser`, `outDay`, `inDay`, `returned`) VALUES
(4, 49, '2017-03-09', '2017-03-15', '2017-03-12');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `deleteditems`
--
...
--
-- Volcado de datos para la tabla `deleteditems`
--

INSERT INTO `deleteditems` (`id`, `title`, `author`, `subject`, `company`, `year`, `editionNumber`, `state`, `description`, `value`, `ISBN`, `type`) VALUES
...
(16, 'title', 'qwer', 'qwer', 'qwer', 1234, 234, 'Good', 'sd', 5, 0, 2);
...
(9, 'Rogue One: A Star Wars Story ', 'George Lucas', 'Science fiction', 'Lucasfilm Ltd.', 2016, 1, 'Good', 'asdf', 5, 0, 2);
...
(48, 'Librarian', 'librarian', 'librarian@librarian.com', '$2y$10$nAJxGRNuFkvLe8pdVfgFO.xH6cUCCNgaXbHGm7YBD/nn1DHcc5.ke', 'librarian 1234', '1234', 'librarian'),
(49, 'Admin', 'admin', 'admin@admin.com', '$2y$10$u45hrjGnWtclLAZxxWBFe.enACmP/oRb/8Ms566ikiNGbKXs2iCMq', 'admin1234', '1234as', 'admin'),
(50, 'user', 'user', 'user@user.com', '$2y$10$MqHk.fsJ3Ow4SG6EqFmZ1uOf1r4h3H.1fwySqrWZIJytuGKn8Ix0a', 'user1234', '1433', 'user'),
(63, 'Jesus', 'Liz Alles', 'jesuslizalles@gmail.com', '$2y$10$pCEGx8agwd7kXGOsJEPVDuKD5Pgy8vGxcIA4Nd6LBxdOkI5cF4V8O', 'asdf', 'asdf', 'peasant');
